...
<!-- 특정 시나리오 task일 때만 아래 섹션을 남긴다. 공통 시스템 task이면 삭제한다. -->
## 적용 시나리오
...
<!-- 이전 단계 산출물이 필요할 때만 아래 섹션을 남긴다. 없으면 삭제한다. -->
## 사전 전제
...
<!-- 구현 후 실제 사람이 변경을 남겨야 하는 절차로 구체화한다. -->
...
- [ ] 적용 범위의 Aeterna 기획 기준과 상태 경계 위반 없음
- [ ] 현재 task 문서가 실제 구현 기준으로 갱신됨

### 결과 확인 (구현 후 구체화)

<!-- 구현 후 실제 사람이 실행하고 관찰할 절차와 기대 결과로 구체화한다. -->
